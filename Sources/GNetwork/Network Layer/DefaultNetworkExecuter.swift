...
@available(iOS 13.0, *)
public struct DefaultNetworkExecuter: NetworkExecuter {
    public init() {}
    
    public func execute(_ request: any Requestable, progress progressHandler: ((_ progress: Int) -> Void)? = nil) async throws -> Data {
